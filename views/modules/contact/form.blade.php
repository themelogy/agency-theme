<div id="contact-form" class="mt-sm-30">
    ...
    <div class="row" data-gutter="10">
        <div class="col-md-6">
            <div class="form-group" :class="{'has-error':errors.first_name}">
                <input type="text" name="first_name" value="" placeholder="{{ trans('contact::contacts.form.first_name') }}" class="form-control form-control-sm text-left" v-model="input.first_name" :class="{ 'is-invalid' : hasError('first_name') }" />
    ...
    <div class="row">
        <div class="col-md-4">
            <button type="submit" class="btn btn-primary pull-left mt-sm-10">{{ trans('global.buttons.send') }}</button>
        </div>
        <div class="col-md-8">
            <div class="form-group pull-right" :class="{'has-error':errors.captcha_contact}">
